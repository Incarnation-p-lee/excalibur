...
static inline void descriptor_table_idt_entry_set(uint32 index, uint32 base, uint16 selector, uint16 attr);
static inline void descriptor_table_idt_init(void);
