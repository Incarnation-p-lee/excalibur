...
bool disk_descriptor_is_active_p(e_dev_id_t device_id);
...
f_disk_read_t disk_descriptor_read(e_dev_id_t device_id);
...
s_disk_pt_table_t * disk_descriptor_pt_table(e_dev_id_t device_id);
static inline bool disk_descriptor_illegal_ip(s_disk_dspt_t *disk_dspt);
static inline bool disk_descriptor_is_active_ip(e_dev_id_t device_id);
...
static inline f_disk_read_t disk_descriptor_read_i(e_dev_id_t device_id);
static inline s_disk_dspt_t * disk_descriptor_entry(e_dev_id_t device_id);
...
static inline s_disk_pt_table_t * disk_descriptor_pt_table_i(e_dev_id_t device_id);
...
static inline uint32 disk_descriptor_sector_bytes_i(e_dev_id_t device_id);
...
static inline void disk_descriptor_is_active_set_i(e_dev_id_t device_id, bool is_active);
static inline void disk_descriptor_sector_bytes_set_i(e_dev_id_t device_id, uint32 sector_bytes);
...
uint32 disk_descriptor_sector_bytes(e_dev_id_t device_id);
...
void disk_descriptor_is_active_set(e_dev_id_t device_id, bool is_active);
void disk_descriptor_sector_bytes_set(e_dev_id_t device_id, uint32 bytes);
