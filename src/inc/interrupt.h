...
/*
 *     Note: cli and sti any effect on maskable external interrupts, and no
 * effect on generation of exception and no maskable interrupts.
 *     Non-maskable interrupts can be generated by external hardware asserts
 * with NMI pin, or the processor receives a message on system bus with a
 * delivery mode NMI.
 */
