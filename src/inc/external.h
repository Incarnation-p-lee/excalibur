...
extern uint32 ata_device_sector_read(s_disk_buf_t *disk_buf, uint32 device_id, uint32 lba);
extern uint32 disk_buffer_size(s_disk_buf_t *disk_buf);
...
extern void disk_buffer_index_set(s_disk_buf_t *disk_buf, uint32 index);
