...
extern bool fs_ext2_descriptor_illegal_p(s_ext2_dspr_t *ext2_dspr);
extern bool fs_ext2_descriptor_legal_p(s_ext2_dspr_t *ext2_dspr);
extern bool fs_ext2_descriptor_table_illegal_p(s_ext2_dspr_table_t *ext2_dspr_table);
extern bool fs_ext2_descriptor_table_legal_p(s_ext2_dspr_table_t *ext2_dspr_table);
...
extern e_disk_id_t fs_ext2_descriptor_device_id(s_ext2_dspr_t *ext2_dspr);
...
extern s_disk_pt_t * fs_ext2_descriptor_disk_pt(s_ext2_dspr_t *ext2_dspr);
extern s_disk_pt_table_t * disk_descriptor_pt_table(e_disk_id_t device_id);
extern s_ext2_bg_info_t * fs_ext2_descriptor_bg_info_array(s_ext2_dspr_t *ext2_dspr);
extern s_ext2_dspr_t * fs_ext2_descriptor_table_dspr_array(s_ext2_dspr_table_t *ext2_dspr_table);
...
extern uint32 disk_descriptor_device_sector_bytes(e_disk_id_t device_id);
...
extern uint32 fs_ext2_descriptor_bg_info_size(s_ext2_dspr_t *ext2_dspr);
extern uint32 fs_ext2_descriptor_table_index(s_ext2_dspr_table_t *ext2_dspr_table);
extern uint32 fs_ext2_descriptor_table_size(s_ext2_dspr_table_t *ext2_dspr_table);
...
extern void fs_ext2_descriptor_bg_info_array_set(s_ext2_dspr_t *ext2_dspr, s_ext2_bg_info_t *bg_info_array);
extern void fs_ext2_descriptor_bg_info_size_set(s_ext2_dspr_t *ext2_dspr, uint32 size);
extern void fs_ext2_descriptor_device_id_set(s_ext2_dspr_t *ext2_dspr, e_disk_id_t device_id);
extern void fs_ext2_descriptor_disk_pt_set(s_ext2_dspr_t *ext2_dspr, s_disk_pt_t *disk_pt);
extern void fs_ext2_descriptor_table_dspr_array_set(s_ext2_dspr_table_t *ext2_dspr_table, s_ext2_dspr_t *dspr_array);
extern void fs_ext2_descriptor_table_index_set(s_ext2_dspr_table_t *ext2_dspr_table, uint32 index);
extern void fs_ext2_descriptor_table_size_set(s_ext2_dspr_table_t *ext2_dspr_table, uint32 size);
