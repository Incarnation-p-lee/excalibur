...
bool filesystem_node_illegal_p(s_fs_node_t *fs_node);
bool filesystem_node_legal_p(s_fs_node_t *fs_node);
...
static inline bool filesystem_node_illegal_ip(s_fs_node_t *fs_node);
static inline bool filesystem_node_legal_ip(s_fs_node_t *fs_node);
...
static inline uint32 filesystem_node_inode_i(s_fs_node_t *fs_node);
static inline uint32 filesystem_node_length_i(s_fs_node_t *fs_node);
uint32 filesystem_close(s_fs_node_t *fs_node);
uint32 filesystem_node_inode(s_fs_node_t *fs_node);
uint32 filesystem_node_length(s_fs_node_t *fs_node);
