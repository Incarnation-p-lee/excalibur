...
static inline bool fs_ext2_block_group_invalid_p(s_ext2_block_group_t *group);
static inline bool fs_ext2_block_group_valid_p(s_ext2_block_group_t *group);
...
static inline s_ext2_block_group_t * fs_ext2_block_group_create(s_disk_buf_t *disk_buf, e_disk_id_t device_id, uint32 sector_offset);
...
static inline s_ext2_dspr_t * fs_ext2_descriptor_create(e_disk_id_t device_id, s_disk_pt_t *pt);
...
static inline uint32 fs_ext2_block_group_sector_count(s_ext2_block_group_t *group, e_disk_id_t device_id);
...
static inline void fs_ext2_descriptor_initialize(s_disk_pt_t *disk_pt, e_disk_id_t device_id, s_ext2_dspr_table_t *dspr_table, s_disk_buf_t *buf, s_ext2_block_group_t *group_primary);
...
static inline void fs_ext2_partition_initialize(s_disk_pt_t *pt, e_disk_id_t device_id, s_ext2_dspr_table_t *dspr_table);
