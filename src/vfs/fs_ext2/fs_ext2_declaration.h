...
static inline uint32 fs_ext2_descriptor_table_limit(s_ext2_dspr_table_t *dspr_table);
...
static inline void fs_ext2_descriptor_print(s_ext2_dspr_t *dspr);
...
static inline void fs_ext2_descriptor_table_print(s_ext2_dspr_table_t *dspr_table);
