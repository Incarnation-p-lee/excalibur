...
static inline e_dev_id_t fs_ext2_dspr_id(s_ext2_dspr_t *dspr);
static inline s_bitmap_t * fs_ext2_bitmap_place(s_block_buf_t *buf, e_dev_id_t id, uint32 sector, uint32 bytes_count);
static inline s_disk_pt_t * fs_ext2_dspr_disk_pt(s_ext2_dspr_t *dspr);
static inline s_ext2_bgd_map_t * fs_ext2_bgd_map_create(s_block_buf_t *buf, e_dev_id_t id, s_ext2_dspr_t *dspr, s_ext2_bgd_t *bgd);
...
static inline s_ext2_bgd_t * fs_ext2_bgd_table_create(s_block_buf_t *buf, e_dev_id_t id, uint32 sector_offset, uint32 size);
...
static inline s_ext2_dir_t * fs_ext2_dir_block_buffer_create(s_block_buf_t *buf, uint32 offset);
static inline s_ext2_dir_t * fs_ext2_dir_create(uint32 size);
static inline s_ext2_dspr_t * fs_ext2_dspr_create(e_dev_id_t id, s_disk_pt_t *pt, s_ext2_spbk_t *superblock, s_ext2_bgd_t *bgd_table);
static inline s_ext2_dspr_t * fs_ext2_dspr_table_entry(s_ext2_dspr_table_t *dspr_table, uint32 i);
static inline s_ext2_dspr_t * fs_ext2_partition_initialize(s_disk_pt_t *pt, e_dev_id_t id);
...
static inline s_ext2_inode_t * fs_ext2_dspr_inode_create(s_ext2_dspr_t *dspr, s_block_buf_t *buf, uint32 inode_addr);
static inline s_ext2_spbk_t * fs_ext2_dspr_superblock(s_ext2_dspr_t *dspr);
static inline s_ext2_spbk_t * fs_ext2_superblock_create(s_block_buf_t *buf, e_dev_id_t id, uint32 sector_offset);
...
static inline void fs_ext2_device_initialize(s_vfs_node_t *root, e_dev_id_t id, s_ext2_dspr_table_t *dspr_table);
...
static inline void fs_ext2_dspr_id_set(s_ext2_dspr_t *dspr, e_dev_id_t id);
static inline void fs_ext2_dspr_inode_destroy(s_ext2_inode_t **inode);
static inline void fs_ext2_dspr_map_array_initialize(s_ext2_dspr_t *dspr, s_block_buf_t *buf, e_dev_id_t id);
...
static inline void fs_ext2_dspr_vfs_tree_dfs_build(s_ext2_dspr_t *dspr, s_stack_t *stack, s_block_buf_t *buf);
static inline void fs_ext2_initialize_i(s_vfs_node_t *root);
static inline void fs_ext2_inode_direct_block_children_add(s_ext2_dspr_t *dspr, s_vfs_node_t *vfs_node, s_ext2_inode_t *inode, s_stack_t *stack, s_block_buf_t *buf);
...
static inline void fs_ext2_vfs_node_children_add(s_ext2_dspr_t *dspr, s_vfs_node_t *vfs_node, s_stack_t *stack, s_block_buf_t *buf);
