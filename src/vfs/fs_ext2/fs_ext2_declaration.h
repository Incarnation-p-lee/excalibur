...
static inline bool fs_ext2_block_group_info_invalid_p(s_ext2_bg_info_t *bg_info);
static inline bool fs_ext2_block_group_info_valid_p(s_ext2_bg_info_t *bg_info);
...
static inline s_ext2_bg_data_t * fs_ext2_descriptor_block_group_data_entry(s_ext2_dspr_t *dspr, uint32 i);
static inline s_ext2_bg_data_t ** fs_ext2_descriptor_block_group_data_array(s_ext2_dspr_t *dspr);
static inline s_ext2_bg_info_t * fs_ext2_block_group_info_create(s_disk_buf_t *disk_buf, e_disk_id_t device_id, uint32 sector_offset);
static inline s_ext2_bg_info_t * fs_ext2_descriptor_block_group_info(s_ext2_dspr_t *dspr);
static inline s_ext2_dspr_t * fs_ext2_descriptor_create(e_disk_id_t device_id, s_disk_pt_t *pt, s_ext2_bg_info_t *bg_info);
...
static inline s_ext2_spbk_t * fs_ext2_block_group_superblock(s_ext2_bg_info_t *bg_info);
...
static inline uint32 fs_ext2_block_group_block_size(s_ext2_bg_info_t *bg_info);
static inline uint32 fs_ext2_block_group_info_block_count(s_ext2_bg_info_t *bg_info);
static inline uint32 fs_ext2_block_group_info_inode_count(s_ext2_bg_info_t *bg_info);
static inline uint32 fs_ext2_block_group_info_superblock_nmbr(s_ext2_bg_info_t *bg_info);
static inline uint32 fs_ext2_block_group_info_superblock_reserved_count(s_ext2_bg_info_t *bg_info);
static inline uint32 fs_ext2_block_group_info_total_block_count(s_ext2_bg_info_t *bg_info);
static inline uint32 fs_ext2_block_group_info_unallocated_block_count(s_ext2_bg_info_t *bg_info);
static inline uint32 fs_ext2_block_group_info_unallocated_inode_count(s_ext2_bg_info_t *bg_info);
static inline uint32 fs_ext2_block_group_major_version(s_ext2_bg_info_t *bg_info);
static inline uint32 fs_ext2_block_group_sector_count(s_ext2_bg_info_t *bg_info, e_disk_id_t device_id);
...
static inline void fs_ext2_block_group_info_destroy(s_ext2_bg_info_t **bg_info);
static inline void fs_ext2_block_group_info_print(s_ext2_bg_info_t *bg_info);
