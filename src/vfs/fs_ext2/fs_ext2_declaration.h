...
static inline uint32 fs_ext2_dspr_inode_direct_children_add(s_ext2_dspr_t *dspr, s_stack_t *stack, s_disk_buf_t *buf, s_ext2_inode_t *inode, uint32 dir_off);
...
static inline void fs_ext2_dspr_inode_children_add(s_ext2_dspr_t *dspr, s_ext2_inode_t *inode, s_stack_t *stack, s_disk_buf_t *buf);
